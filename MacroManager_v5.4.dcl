// ═══════════════════════════════════════════════════════════════════════════
// PROFESSIONAL MACRO MANAGER v5.4 DCL
// With Auto-Execute Script, Multiple Export Methods, and Preview
// ═══════════════════════════════════════════════════════════════════════════
// NEW in v5.4:
//   - Auto-execute script after export (no manual SCRIPT command)
//   - Three export methods: Script (auto) / ActiveX-VLA / Direct WBLOCK
//   - User-selectable export method via radio buttons
//   - Script-based WBLOCK export (crash-free)
//   - Type/Category dropdown (8 categories)
//   - Preview before import (list box with block details)
//   - Block Library folder selection for Export/Import
//   - Session memory for paths and settings
// ═══════════════════════════════════════════════════════════════════════════

UnifiedMacroDialog : dialog {
  label = "Professional Macro Manager v5.4";
