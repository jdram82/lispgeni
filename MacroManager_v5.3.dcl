// ═══════════════════════════════════════════════════════════════════════════
// PROFESSIONAL MACRO MANAGER v5.3 DCL
// With Script-based WBLOCK, Type Dropdown, and Preview Functionality
// ═══════════════════════════════════════════════════════════════════════════
// NEW in v5.3:
...
UnifiedMacroDialog : dialog {
  label = "Professional Macro Manager v5.3";
    ...
    : boxed_column {
      ...
      : radio_column {
        : radio_button {
          ...
          label = "Script Method (Recommended - Most Stable)";
          value = "1";
        }
        : radio_button {
          key = "export_method_vla";
          label = "ActiveX/VLA Method (Try if script fails)";
          value = "0";
        }
        : radio_button {
      ...
      : text {
        label = "(Script method auto-executes after CSV export)";
        width = 50;
      }
    }
