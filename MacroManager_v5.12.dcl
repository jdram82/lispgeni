// ═══════════════════════════════════════════════════════════════════════════
// PROFESSIONAL MACRO MANAGER v5.12 DCL
// With Fixed Script Format & Import Error Handling
// ═══════════════════════════════════════════════════════════════════════════
// NEW in v5.12:
//   - Fixed script format (removed extra blank line - no base point prompt)
//   - Fixed import process (command mode management, error trapping)
//   - Explicit INSERT parameters (1.0, 1.0, 0.0 instead of empty strings)
//   - Import diagnostics with detailed progress for each block
//   - CMDECHO suppression during import for speed
//   - Better error messages showing exactly which blocks fail and why
// ═══════════════════════════════════════════════════════════════════════════

UnifiedMacroDialog : dialog {
  label = "Professional Macro Manager v5.12";
