...
' VERSION: 3.1 - AUTOLISP FORMAT COMPATIBLE (CORRECTED)
' ============================================================================
...
' ============================================================================
' CHANGES in v3.1:
'   - Fixed CSV import to properly map AutoLISP format fields
'   - Updated headers to match AutoLISP export format
'   - Corrected export function to read from proper columns
'   - Added AutoCAD integration functions
' ============================================================================

Option Explicit

' ============================================================================
' ENHANCED CSV PARSING FOR AUTOLISP FORMAT
' ============================================================================

Sub ImportFromCSV_Click()
    'Import CSV file to Macro Library - AutoLISP Format
...
Sub ImportVerifiedCSVFormat(csvPath As String)
    'Import CSV file in AutoLISP export format
    ...
    If Not csvFile.AtEndOfStream Then
        ...
        ' Check if first line looks like data (doesn't start with "Block" or "Sl")
        If InStr(1, Trim(line), "Block Name", vbTextCompare) > 0 Or _
           InStr(1, Trim(line), "Sl.No", vbTextCompare) > 0 Then
            ' This was a header line, skip it
        Else
...
ProcessLine:
        If line <> "" Then
            ...
            If UBound(fields) >= 6 Then
                ' Map to Excel columns based on AutoLISP format
                wsMacroLibrary.Cells(row, 1).Value = serialNo         ' Sl.No (Auto-generated)
...
Sub ExportSelectedMacrosToProjectCSV(csvPath As String)
    ...
    For row = 2 To lastRow
        ...
        If Trim(wsSelectedMacros.Cells(row, 2).Value) <> "" Then
            ' Extract data from Selected Macros - AutoLISP format
...
Sub SetupMacroLibraryHeaders()
    ...
    With wsMacroLibrary
        ...
        .Columns("B:B").ColumnWidth = 25  ' Block Name
