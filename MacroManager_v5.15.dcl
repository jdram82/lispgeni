// ═══════════════════════════════════════════════════════════════════════════
// PROFESSIONAL MACRO MANAGER v5.15 DCL
// Stable Release - Export & Import Fixed!
// ═══════════════════════════════════════════════════════════════════════════
// NEW in v5.15:
//   - Fixed export script format (blank line after WBLOCK commands)
//   - Fixed folder selection (simplified, reliable method)
//   - Export tested and working (62 blocks successfully exported)
//   - Import uses XREF method (no INSERT crashes)
//   - Script-based workflows (safe and predictable)
// ═══════════════════════════════════════════════════════════════════════════

macromanager : dialog {
  label = "Professional Macro Manager v5.15 - Stable Release";
